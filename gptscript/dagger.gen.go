...
func (r *Gptscript) UnmarshalJSON(bs []byte) error {
	var concrete struct{}
...
func invoke(ctx context.Context, parentJSON []byte, parentName string, fnName string, inputArgs map[string][]byte) (_ any, err error) {
	...
	case "Gptscript":
		...
		case "ContainerEcho":
			...
			return (*Gptscript).ContainerEcho(&parent, stringArg), nil
		case "GrepDir":
			var parent Gptscript
			err = json.Unmarshal(parentJSON, &parent)
			if err != nil {
			...
			return (*Gptscript).GrepDir(&parent, ctx, directoryArg, pattern)
		default:
	...
	case "":
		return dag.Module().
			WithObject(
				dag.TypeDef().WithObject("Gptscript").
					WithFunction(
