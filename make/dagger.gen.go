...
func invoke(ctx context.Context, parentJSON []byte, parentName string, fnName string, inputArgs map[string][]byte) (any, error) {
	...
	case "Directory":
		...
		case "Make":
			...
			return (*Directory).Make(&parent, ctx, args)
		default:
	...
	case "Make":
		...
		case "Make":
			...
			return (*Make).Make(&parent, ctx, &dir, args)
		case "":
			var err error
			var typeDefBytes []byte = []byte("{\"asObject\":{\"functions\":[{\"args\":[{\"name\":\"dir\",\"typeDef\":{\"asObject\":{\"functions\":[{\"args\":[{\"name\":\"args\",\"typeDef\":{\"asList\":{\"elementTypeDef\":{\"kind\":\"StringKind\"}},\"kind\":\"ListKind\"}}],\"name\":\"Make\",\"returnType\":{\"asObject\":{\"name\":\"Directory\"},\"kind\":\"ObjectKind\"}}],\"name\":\"Directory\"},\"kind\":\"ObjectKind\"}},{\"name\":\"args\",\"typeDef\":{\"asList\":{\"elementTypeDef\":{\"kind\":\"StringKind\"}},\"kind\":\"ListKind\"}}],\"name\":\"Make\",\"returnType\":{\"asObject\":{\"name\":\"Directory\"},\"kind\":\"ObjectKind\"}}],\"name\":\"Make\"},\"kind\":\"ObjectKind\"}")
