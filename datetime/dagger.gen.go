...
func (r *Client) InlinePython() *InlinePython {
...
func invoke(ctx context.Context, parentJSON []byte, parentName string, fnName string, inputArgs map[string][]byte) (any, error) {
	...
	case "Datetime":
		...
		case "Now":
			...
			return (*Datetime).Now(&parent, ctx)
		case "":
			var err error
			var typeDefBytes []byte = []byte("{\"asObject\":{\"functions\":[{\"name\":\"Now\",\"returnType\":{\"kind\":\"StringKind\"}}],\"name\":\"Datetime\"},\"kind\":\"ObjectKind\"}")
