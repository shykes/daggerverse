...
func invoke(ctx context.Context, parentJSON []byte, parentName string, fnName string, inputArgs map[string][]byte) (any, error) {
	...
	case "Container":
		...
		case "TTLPush":
			...
			return (*Container).TTLPush(&parent, ctx, repo, tag)
		default:
	...
	case "Ttlsh":
		...
		case "Publish":
			...
			return (*Ttlsh).Publish(&parent, ctx, &ctr, repo, tag)
		case "":
			var err error
			var typeDefBytes []byte = []byte("{\"asObject\":{\"functions\":[{\"args\":[{\"name\":\"ctr\",\"typeDef\":{\"asObject\":{\"functions\":[{\"args\":[{\"name\":\"repo\",\"typeDef\":{\"kind\":\"StringKind\"}},{\"name\":\"tag\",\"typeDef\":{\"kind\":\"StringKind\"}}],\"description\":\"Publish a container to ttl.sh\\n\",\"name\":\"TTLPush\",\"returnType\":{\"kind\":\"StringKind\"}}],\"name\":\"Container\"},\"kind\":\"ObjectKind\"}},{\"name\":\"repo\",\"typeDef\":{\"kind\":\"StringKind\"}},{\"name\":\"tag\",\"typeDef\":{\"kind\":\"StringKind\"}}],\"description\":\"Publish a container to ttl.sh\\n\",\"name\":\"Publish\",\"returnType\":{\"kind\":\"StringKind\"}}],\"name\":\"Ttlsh\"},\"kind\":\"ObjectKind\"}")
