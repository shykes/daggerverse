...
type Dagger = dagger.Dagger

// Dagger Cloud
type DaggerCloud = dagger.DaggerCloud

// The Dagger Engine
type DaggerEngine = dagger.DaggerEngine

// Participate in developing the open-source Dagger Engine
type DaggerEngineDev = dagger.DaggerEngineDev

// DaggerEngineDevBranchOpts contains options for DaggerEngineDev.Branch
type DaggerEngineDevBranchOpts = dagger.DaggerEngineDevBranchOpts

type DaggerEngineRelease = dagger.DaggerEngineRelease

type DaggerEngineSource = dagger.DaggerEngineSource

// DaggerEngineSourceCliOpts contains options for DaggerEngineSource.Cli
type DaggerEngineSourceCliOpts = dagger.DaggerEngineSourceCliOpts

type DaggerWorker = dagger.DaggerWorker

type WithDaggerWorkerFunc = dagger.WithDaggerWorkerFunc
...
func invoke(ctx context.Context, parentJSON []byte, parentName string, fnName string, inputArgs map[string][]byte) (_ any, err error) {
	...
	case "Daggy":
		...
		case "Debug":
			...
			return (*Daggy).Debug(&parent, token), nil
		case "Container":
			var parent Daggy
			err = json.Unmarshal(parentJSON, &parent)
			if err != nil {
				...
				dag.TypeDef().WithObject("Daggy").
					...
					WithFunction(
						dag.Function("Debug",
							...
							WithArg("token", dag.TypeDef().WithObject("Secret").WithOptional(true), FunctionWithArgOpts{Description: "OpenAI API key"})).
					WithFunction(
