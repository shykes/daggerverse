...
func (r *DaggerEngine) Releases(ctx context.Context) ([]DaggerEngineRelease, error) {
	...
	convert := func(fields []releases) []DaggerEngineRelease {
		...
		for i := range fields {
			...
			val.Query = querybuilder.Query().Select("loadDaggerEngineReleaseFromID").Arg("id", fields[i].Id)
			val.Client = r.Client
			out = append(out, val)
		}
...
func (r *DaggerWorker) Containers(ctx context.Context) ([]Container, error) {
	...
	convert := func(fields []containers) []Container {
		...
		for i := range fields {
			...
			val.Query = querybuilder.Query().Select("loadContainerFromID").Arg("id", fields[i].Id)
			val.Client = r.Client
			out = append(out, val)
		}
...
func (r *Client) LoadDaggerCloudFromID(id DaggerCloudID) *DaggerCloud {
	q := r.Query.Select("loadDaggerCloudFromID")
	q = q.Arg("id", id)
...
func (r *Client) LoadDaggerEngineDevFromID(id DaggerEngineDevID) *DaggerEngineDev {
	q := r.Query.Select("loadDaggerEngineDevFromID")
	q = q.Arg("id", id)
...
func (r *Client) LoadDaggerEngineReleaseFromID(id DaggerEngineReleaseID) *DaggerEngineRelease {
	q := r.Query.Select("loadDaggerEngineReleaseFromID")
	q = q.Arg("id", id)
...
func (r *Client) LoadDaggerEngineSourceFromID(id DaggerEngineSourceID) *DaggerEngineSource {
	q := r.Query.Select("loadDaggerEngineSourceFromID")
	q = q.Arg("id", id)
...
func (r *Client) LoadDaggerFromID(id DaggerID) *Dagger {
	q := r.Query.Select("loadDaggerFromID")
	q = q.Arg("id", id)
...
func (r *Client) LoadDaggerWorkerFromID(id DaggerWorkerID) *DaggerWorker {
	q := r.Query.Select("loadDaggerWorkerFromID")
	q = q.Arg("id", id)
